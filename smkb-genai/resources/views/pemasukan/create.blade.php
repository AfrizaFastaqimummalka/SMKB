...
@section('content')
    <form method="POST" action="{{ route('pemasukan.store') }}" class="max-w-md space-y-4">
        @csrf
        <div>
        ...
        <div class="flex gap-3">
            ...
            <a href="{{ route('pemasukan.index') }}" class="text-sm text-slate-500 self-center hover:text-navy-950">Batal</a>
        </div>
    </form>
@endsection
